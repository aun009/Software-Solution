      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
        ...
        <div className="lg:col-span-7">
          ...
          >
            ...
            <h1 className="text-4xl md:text-8xl font-black text-gray-900 mb-6 md:mb-10 tracking-tighter leading-tight md:leading-[0.9]">
              {product.title}
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6">
              <button className="px-10 md:px-12 py-4 md:py-5 bg-blue-600 text-white rounded-2xl font-black text-base md:text-lg shadow-xl shadow-blue-500/20 transition-all active:scale-95 group">
                {product.ctaText || 'Get Started'}
                <ArrowRight size={20} className="inline-block ml-3 group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="px-10 md:px-12 py-4 md:py-5 bg-white border border-gray-200 text-gray-900 rounded-2xl font-black text-base md:text-lg transition-all active:scale-95 hover:bg-gray-50">
                Technical Docs
              </button>
            </div>
          </motion.div>
        ...
        <div className="lg:col-span-5">
          ...
          >
            {/* Image/Demo Area */}
            <div className="group relative aspect-[4/5] bg-gray-50 border border-gray-200 rounded-[32px] md:rounded-[40px] overflow-hidden shadow-2xl flex items-center justify-center">
