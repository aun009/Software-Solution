...
export const Reviews = () => {
  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden border-t border-gray-100 font-sans">
        ...
        {!showAll && (
          ...
          >
            <button
              ...
              className="px-6 py-2.5 bg-gray-100 hover:bg-gray-200 border border-gray-200 text-gray-800 rounded-lg text-sm font-semibold transition-all"
            >
              See More
            </button>
          </motion.div>
